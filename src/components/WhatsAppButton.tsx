...
export default function WhatsAppButton({ whatsappNumber }: { whatsappNumber?: string }) {
  ...
  // Ensure WhatsApp number is formatted properly (remove spaces, +, etc)
  ...
  return (
    ...
    >
      <div className="bg-[#25D366] text-white p-3.5 rounded-full flex items-center justify-center shadow-lg">
        <svg
