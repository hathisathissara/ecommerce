          ...
          <div className="lg:col-span-5 bg-gray-50 p-6 sm:p-8 rounded-2xl border border-gray-100 space-y-6">
            ...
            <div className="space-y-5 text-xs sm:text-sm text-gray-600">
              ...
              <div>
                ...
                <p className="mt-1 text-gray-950 font-medium">
                ...
                {settings.whatsappNumber && (
                  <a
                    ...
                    className="mt-2 inline-flex items-center gap-1.5 text-sm text-[#25D366] hover:text-[#1da851] font-medium transition"
                  >
